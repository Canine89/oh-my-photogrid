...
## 다운로드
**[최신 APK 받기 (Releases)](https://github.com/Canine89/oh-my-photogrid/releases/latest)** — `oh-my-photogrid-1.6.0.apk`
...
3. 또는 PC에서 `adb install -r oh-my-photogrid-1.6.0.apk`

무결성 확인: `shasum -a 256 oh-my-photogrid-1.6.0.apk`의 결과를 릴리스에 첨부된 `.sha256` 파일과 비교한다.
